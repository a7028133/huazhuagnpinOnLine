...
@interface SXTBuyCarTotalPriceView()

@property (strong, nonatomic)   UILabel *totalLabel;              /** 合计label */
@property (strong, nonatomic)   UILabel *mailLabel;              /** 邮寄方式 */

@end


@implementation SXTBuyCarTotalPriceView
